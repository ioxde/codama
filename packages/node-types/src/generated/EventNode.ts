...
// ioxde fork: `EventFraming` has no `@codama/spec` counterpart; hand-written sibling module.
...
> {
    ...
    readonly docs?: Docs;
    // ioxde fork: how the event payload is framed on the wire — see `EventFraming`.
