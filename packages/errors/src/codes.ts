...
export const CODAMA_ERROR__VISITORS__INVALID_CPI_DISCRIMINATOR_TYPE = 1200013;
export const CODAMA_ERROR__VISITORS__CANNOT_FLATTEN_STRUCT_REFERENCED_AS_A_WHOLE = 1200014;
...
export const CODAMA_ERROR__ANCHOR__CPI_EVENTS_UNKNOWN_PROGRAM = 2100008;
export const CODAMA_ERROR__ANCHOR__CPI_EVENTS_UNKNOWN_EVENT = 2100009;
export const CODAMA_ERROR__ANCHOR__CPI_EVENTS_DUPLICATE_PROGRAM = 2100010;
...
export const CODAMA_ERROR__DYNAMIC_CLIENT__PDA_REQUIRES_PROGRAM_ADDRESS = 2500020;
...
export type CodamaErrorCode =
    ...
    | typeof CODAMA_ERROR__ANCHOR__CPI_EVENTS_DUPLICATE_PROGRAM
    | typeof CODAMA_ERROR__ANCHOR__CPI_EVENTS_UNKNOWN_EVENT
    | typeof CODAMA_ERROR__ANCHOR__CPI_EVENTS_UNKNOWN_PROGRAM
    ...
    | typeof CODAMA_ERROR__DYNAMIC_CLIENT__PDA_REQUIRES_PROGRAM_ADDRESS
    ...
    | typeof CODAMA_ERROR__VISITORS__CANNOT_FLATTEN_STRUCT_REFERENCED_AS_A_WHOLE
    ...
    | typeof CODAMA_ERROR__VISITORS__INVALID_CPI_DISCRIMINATOR_TYPE
