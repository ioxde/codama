...
`@codama/nodes/src/generated/` and `@codama/visitors-core/src/generated/`).
...
├── nodes/          # generator for @codama/nodes/src/generated/
├── visitorsCore/   # generator for @codama/visitors-core/src/generated/
└── shared/         # helpers shared by the generators

bin/generate.ts     # pnpm generate entry; wraps the orchestrator

test/               # unit tests, mirroring the src/ layout
├── nodeTypes/
├── nodes/
├── visitorsCore/
└── shared/
