...
export function generateClientTypes(idl: RootNode): string {
    ...
    // ioxde fork: `emitProgramAddressConfig` must stay in step with the `PDA_REQUIRES_PROGRAM_ADDRESS`
    // guard in `create-program-client.ts`, which throws when the program address is missing.
